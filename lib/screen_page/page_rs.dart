...
class _PageRumahSakitState extends State<PageRumahSakit> {
  ...
  Future<void> fetchRumahSakitData() async {
    ...
    try {
      final response = await http.get(Uri.parse('http://192.168.1.17/rumahsakitDB/getRS.php?id_kabupaten=${widget.kabupatenId}'));
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: Card(
                    ...
                    elevation: 5,
                    child: ListTile(
                      leading: Image.network('http://192.168.1.17/rumahsakitDB/gambar/${rumahSakit.gambar}', width: 100, height: 80,),
                      title: Text(
                        rumahSakit.namaRs,
                        style: TextStyle(
                          color: Colors.green,
